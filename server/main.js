...
function saveNewVenue(venues) {
    return new Promise(function (resolve, reject) {
        fs.writeFile(path.resolve(process.cwd(), './data/venue.json'), JSON.stringify(venues), function (err) {
            if (err) {
                reject();
            } else {
                resolve();
...
// function loadVenues() {
    //     return new Promise(patchVenuesPromiseExecuter);
    // }


// function updateVenues(request, response) {
//     setResponseHeaders(request, response);
//     let buffer = [];
//     let object = null;
...
// function patchVenuesPromiseExecuter(object) {
//     return new Promise(function (resolve, reject) {
//         fs.writeFile(path.resolve(process.cwd(), './data/venues.json'), JSON.stringify(object), function (err) {
//             if (err) {
//                 reject();
//             } else {
//                 resolve();
